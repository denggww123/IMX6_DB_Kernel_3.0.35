...
#ifndef _BOARD_MX6DL_QIYANG_H
#define _BOARD_MX6DL_QIYANG_H
#include <mach/iomux-mx6dl.h>

//////////////////////////////////////////////////////////////////
static iomux_v3_cfg_t mx6dl_qiyang_i2c_pads[] =
{
...
static iomux_v3_cfg_t mx6dl_qiyang_spi_pads[] = 
{
#if 0
	MX6DL_PAD_SD1_CMD__ECSPI5_MOSI,
	MX6DL_PAD_SD1_CLK__ECSPI5_SCLK,
	MX6DL_PAD_SD1_DAT0__ECSPI5_MISO,
	MX6DL_PAD_SD1_DAT1__GPIO_1_17, //cs0
	MX6DL_PAD_SD1_DAT2__GPIO_1_19, //cs1
	MX6DL_PAD_SD1_DAT3__GPIO_1_21, //cs2
#endif
	MX6DL_PAD_EIM_D16__ECSPI1_SCLK,
	MX6DL_PAD_EIM_D17__ECSPI1_MISO,
	MX6DL_PAD_EIM_D18__ECSPI1_MOSI,
	MX6DL_PAD_EIM_EB2__GPIO_2_30,  //cs0	
	MX6DL_PAD_EIM_D19__GPIO_3_19,  //cs1
};
static iomux_v3_cfg_t mx6dl_qiyang_misc_pads[] = 
{
	MX6DL_PAD_GPIO_0__CCM_CLKO,   //CLK ouput

	MX6DL_PAD_SD2_CLK__GPIO_1_10, //hub rst
	MX6DL_PAD_SD2_CMD__GPIO_1_11, //phy rst
	MX6DL_PAD_SD3_DAT4__GPIO_7_1, //sd3 wr
	MX6DL_PAD_SD3_DAT5__GPIO_7_0, //sd3 cd

	MX6DL_PAD_GPIO_1__GPIO_1_1,   //j16_19
	MX6DL_PAD_GPIO_2__GPIO_1_2,   //j16_20

	MX6DL_PAD_GPIO_3__GPIO_1_3,   //j17_19
	MX6DL_PAD_GPIO_4__GPIO_1_4,   //j17_20

	MX6DL_PAD_GPIO_18__GPIO_7_13, //j19_4
	MX6DL_PAD_GPIO_19__GPIO_4_5,  //j19_5

	//MX6DL_PAD_CSI0_DAT4__GPIO_5_22, //j22_8	
	MX6DL_PAD_CSI0_DAT5__GPIO_5_23, //j22_18
	MX6DL_PAD_CSI0_DAT6__GPIO_5_24, //j22_20
	
	MX6DL_PAD_NANDF_CS0__GPIO_6_11, //AMP L
	MX6DL_PAD_NANDF_CS1__GPIO_6_14, //AMP R

	MX6DL_PAD_EIM_D20__GPIO_3_20,   //ads7846 busy
	MX6DL_PAD_EIM_D21__GPIO_3_21,   //ads7846 int

	MX6DL_PAD_GPIO_16__GPIO_7_11,   //sata pwr led

	MX6DL_PAD_GPIO_7__GPIO_1_7,     //pcie disable
	MX6DL_PAD_GPIO_8__GPIO_1_8,     //pcie reset

	MX6DL_PAD_EIM_BCLK__GPIO_6_31, //buzzer for single
	
	MX6DL_PAD_EIM_A22__GPIO_2_16,   //j31_1
	MX6DL_PAD_EIM_A21__GPIO_2_17,   //j31_3
	MX6DL_PAD_EIM_A20__GPIO_2_18,   //j31_5
	MX6DL_PAD_EIM_A19__GPIO_2_19,   //j31_7
	MX6DL_PAD_EIM_A18__GPIO_2_20,   //j31_2
	MX6DL_PAD_EIM_A17__GPIO_2_21,   //j31_4
	MX6DL_PAD_EIM_A16__GPIO_2_22,   //j31_6
	MX6DL_PAD_EIM_CS0__GPIO_2_23,   //j31_8 

	MX6DL_PAD_SD3_DAT6__GPIO_6_18,  //otg pwr
	MX6DL_PAD_SD3_RST__GPIO_7_8,    //otg id
	MX6DL_PAD_SD3_DAT7__GPIO_6_17,  //otg oc
	

	MX6DL_PAD_EIM_D22__GPIO_3_22,  //enable pin
	MX6DL_PAD_EIM_D23__GPIO_3_23,  //feed_dog pin 

};


static iomux_v3_cfg_t mx6dl_qiyang_matrix_keys_pads[] = 
{
...
static iomux_v3_cfg_t mx6dl_qiyang_csi0_pads[] =
{
...
static iomux_v3_cfg_t mx6dl_qiyang_disp0_pads[] =
{
...
static iomux_v3_cfg_t mx6dl_qiyang_sd_pads[] = {
...
static iomux_v3_cfg_t mx6dl_qiyang_uart_pads[] = {
	...
	MX6DL_PAD_EIM_D29__GPIO_3_29,  //rs485 ctl

	MX6DL_PAD_EIM_D24__UART3_TXD,
	MX6DL_PAD_EIM_D25__UART3_RXD,

	MX6DL_PAD_EIM_D31__GPIO_3_31,	//rs485 ctl
...
static iomux_v3_cfg_t mx6dl_qiyang_rgmii_pads[] = {
...
static iomux_v3_cfg_t mx6dl_qiyang_audio_pads[] = {
	/*Iac*/
...
static iomux_v3_cfg_t mx6dl_qiyang_can_pads[] = {
