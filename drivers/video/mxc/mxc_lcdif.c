...
static struct fb_videomode lcdif_modedb[] = {
	...
	{
   /* 800x480 @ 60 Hz , pixel clk @ 32MHz */
        "QY-WVGA", 60, 800, 480, 34209 , 48 , 40 , 10 , 10, 40, 20,
        FB_SYNC_CLK_LAT_FALL,
        FB_VMODE_NONINTERLACED,
        0,},
        {
	...
	0,},
        {
	/* 800x600 @ 60 Hz , pixel clk @ 32MHz */
	"QY-LCD-800X600", 60, 800, 600, 27778, 101, 23,  22,  1, 100, 2,
	FB_SYNC_CLK_LAT_FALL,
	//FB_SYNC_CLK_IDLE_EN,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	/* 1024X768 @ 60 Hz , pixel clk @ 32MHz */
	"QY-LCD-1024X768", 60, 1024, 768, 15385, 160,  24,  29,  3, 136, 6,
	FB_SYNC_CLK_LAT_FALL,
	//FB_SYNC_CLK_IDLE_EN,
	FB_VMODE_NONINTERLACED,
	0,},
	{/* 800x480 @ 60 Hz , pixel clk @ 32MHz */
	"QY-VGA-800X480", 60, 800, 480, 27000, 40, 40, 29, 13, 48, 3,
	//FB_SYNC_CLK_LAT_FALL,
	FB_SYNC_CLK_IDLE_EN,
	FB_VMODE_NONINTERLACED,
	0,},
	 ...
	 {
	/* 800x600 @ 60 Hz , pixel clk @ 32MHz */
	"QY-VGA-800X600", 60, 800, 600, 27778, 101, 23,  22,  1, 100, 2,
	//FB_SYNC_CLK_LAT_FALL,
	FB_SYNC_CLK_IDLE_EN,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	/* 1024X768 @ 60 Hz , pixel clk @ 32MHz */
	"QY-VGA-1024X768", 60, 1024, 768, 15385, 160,  24,  29,  3, 136, 6,
	//FB_SYNC_CLK_LAT_FALL,
	FB_SYNC_CLK_IDLE_EN,
	FB_VMODE_NONINTERLACED,
	0,},
